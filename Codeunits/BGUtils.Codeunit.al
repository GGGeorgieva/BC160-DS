codeunit 46015505 "BG Utils"
{
    ...
    begin
        case GLOBALLANGUAGE of
          1026 : exit(NumsToWordsBG(number,curCode));
          1033 : exit(NumsToWordsBG(number,curCode));
        else
    ...
    begin
        ...
        case ch of
          1 :    s1 := Text16219;
          2,3 :  s1 := NumsToWords_N(ch) + Text16220;
          4..9:  s1 := NumsToWords_N(ch) + Text16221;
        end;
        s1 := s1 + ' ';
        ...
        case ch of
          1 : s1 := s1 + NumsToWords_NR1(rod) + ' ';
          2 : s1 := s1 + NumsToWords_NR2(rod) + ' ';
          3..9 : s1 := s1 + NumsToWords_N(ch) + ' ';
        end;
