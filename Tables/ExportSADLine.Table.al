table 46015625 "Export SAD Line"
{
    ...
    fields
    {
        ...
        field(3; "Document No."; Code[20])
        {
            ...
            ELSE
            IF ("Document Type" = CONST("Credit Memo")) "Sales Cr.Memo Header" WHERE("SAD No." = CONST(''));
            ...
            begin
                ...
                if "Document Type" = "Document Type"::Invoice then begin
                    ...
                    // TODO MISSING METHOD UpdateInvoiceSADNo
                    ...
                    // TODO MISSING METHOD UpdateCrMemoSADNo
    ...
    trigger OnDelete();
    begin
        //TODO MISSING METHODS UpdateInvoiceSADNo AND UpdateCrMemoSADNo
        /*
    ...
    begin
        ...
        // TODO MISSING PAGE Page46012274
