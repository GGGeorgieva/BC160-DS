table 46015623 "Import SAD Line"
{
    ...
    fields
    {
        ...
        field(3; "Document No."; Code[20])
        {
            ...
            ELSE
            IF ("Document Type" = CONST("Credit Memo")) "Purch. Cr. Memo Hdr." WHERE("SAD No." = CONST(''));
            ...
            begin
                ...
                if "Document Type" = "Document Type"::Invoice then begin
                    ...
                    //TODO MISSING UpdateInvoiceSADNo
                    ...
                    // TODO MISSING UpdateCrMemoSADNo
    ...
    trigger OnDelete();
    begin
        //TODO MISSING UpdateInvoiceSADNo AND UpdateCrMemoSADNo
        /*
    ...
    begin
        ...
        // TODO MISSING PAGE "SAD Payments
